...
class GhostTapOption extends Option
{
	...
	private override function updateDisplay():String
	{
		return FlxG.save.data.ghost ? "Having skill" : "Having skill issue";
	}
}
...
class OffsetMenu extends Option
{
	...
	{
		trace("switch");
		var poop:String = Highscore.formatSong("Training", 1);

		PlayState.SONG = Song.loadFromJson(poop, "Training");
